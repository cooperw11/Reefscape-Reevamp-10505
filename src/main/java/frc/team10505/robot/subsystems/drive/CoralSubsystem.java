...
public class CoralSubsystem extends SubsystemBase{
    ...
    private MechanismLigament2d flywheelLeftVis = new MechanismLigament2d("Left Flywheel", kIntakeLeft,CORAL_MOTOR_CURRENT_LIMIT,kIntakeLeft, null);
    private MechanismLigament2d flywheelRightVis = new MechanismLigament2d("Right Flywheel", kIntakeRight,CORAL_MOTOR_CURRENT_LIMIT,kIntakeRight, null);
    ...
    public CoralSubsystem() {
      ...
      flywheelLeft.configure(coralLeftConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
        flywheelRight.configure(coralRightConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
